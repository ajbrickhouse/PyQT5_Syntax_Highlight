# syntax.py
# Code found at: https://wiki.python.org/moin/PyQt/Python%20syntax%20highlighting
...
STYLES = {
    ...
    'string': format('#ce8a5d'),
    'docString': format('darkMagenta'),
    'comment': format('#7ca668'),
    'self': format('#9cdcfe'),
    'numbers': format('#b5be6d'),
}
